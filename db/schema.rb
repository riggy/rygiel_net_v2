...
ActiveRecord::Schema[8.1].define(version: 2026_05_24_185015) do
  ...
  create_table "trackguard_blocked_paths", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["pattern"], name: "index_trackguard_blocked_paths_on_pattern", unique: true
  end
  ...
  create_table "trackguard_visitors", force: :cascade do |t|
    ...
    t.string "suspicious_state", default: "normal", null: false
    t.datetime "updated_at", null: false
    t.string "user_agent"
